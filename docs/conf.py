...
"""
openedx-wallet documentation build configuration file.
...
project = 'openedx-wallet'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Open edX Wallet'
...
#
# html_title = 'openedx-wallet v0.0.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'A simple storage backend for Open edX Credentials verifiable credentials onboarding',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_wallet'),
                os.path.join(root_path, 'openedx_wallet/migrations')])
